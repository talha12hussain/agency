...
const Footer = () => {
    ...
    lg:flex-row justify-between items-start gap-10 lg:gap-4 px-10 py-14 lg:px-20 lg:py-28'>
            <div className=' flex flex-col justify-center items-start gap-2 w-full  lg:w-[40%]'>
                ...
                <p className=' text-lg text-slate-200'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure, voluptas! Esse, enim
                    impedit possimus inventore exercitationem perspiciatis accusamus molestias cupiditate!</p>
                <div className=' flex justify-center items-center gap-4 mt-7' id='logo'>
                    <span className=' bg-white p-2 rounded-full cursor-pointer hover:bg-green-600'>
                        <img src={fb} alt="fb" width={20} height={20} /></span>
                    <span className=' bg-white p-2 rounded-full cursor-pointer hover:bg-green-600'>
                        <img src={insta} alt="insta" width={20} height={20} /></span>
                    <span className=' bg-white p-2 rounded-full cursor-pointer hover:bg-green-600'>
                        <img src={twitter} alt="twitter" width={20} height={20} /></span>
                    <span className=' bg-white p-2 rounded-full cursor-pointer hover:bg-green-600'>
                        <img src={yt} alt="yt" width={20} height={20} /></span>
                </div>
            </div>
